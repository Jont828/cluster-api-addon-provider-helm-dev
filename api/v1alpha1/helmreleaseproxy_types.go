...
type HelmReleaseProxySpec struct {
	...
	// ReleaseName is the release name of the installed Helm chart. If the `GenerateReleaseName` install option is set, then this field will be auto-generated by the webhook.
	// +optional
